...
// PORT and BASE_PATH are only needed for the dev server; during a production
// build they are not set, so fall back to safe defaults.
  ...
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        ...
        description: 'No Man\'s Sky space station tracker',
        theme_color: '#0a0e1a',
